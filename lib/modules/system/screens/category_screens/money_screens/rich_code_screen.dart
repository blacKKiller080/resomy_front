...
class RichCodeScreen extends StatelessWidget implements Navigatable {
  @override
  ...
  Widget calculation(BuildContext context) => Container(
        child: Column(
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushNamed(context, Routes.rich_code_result);
              },
              child: Container(
                width: 39.2.w,
                height: 5.55.h,
  ...
  Widget information() => Positioned(
        ...
        child: Container(
          child: ListView(
            ...
            children: [
              Text(
                '''Код богатства в нумерологии показывает человеку его перспективу в денежных делах. Он дает возможность понять свой финансовый потенциал. Можно узнать, стоит ли рисковать, начинать бизнес, давать взаймы, брать кредиты. 

Личный код богатства дается человеку при рождении, и остается с ним на протяжении всей жизни. Не каждое число привлекает успех, но при правильном использовании, дает возможность избежать многих потерь и разочарований.''',
                style: GoogleFonts.montserrat(
                  fontSize: 11.sp,
                  color: Color.fromARGB(255, 73, 80, 87),
  ...
  @override
  String getName() {
    return Routes.rich_code_screen;
  }
}
