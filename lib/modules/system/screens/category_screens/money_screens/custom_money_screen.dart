...
class CustomMoneyScreen extends StatelessWidget implements Navigatable {
  @override
  ...
  Widget calculation(BuildContext context) => Container(
        child: Column(
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushNamed(context, Routes.custom_money_result);
              },
              child: Container(
                width: 39.2.w,
                height: 5.55.h,
  ...
  Widget information() => Positioned(
        ...
        child: Container(
          child: ListView(
            ...
            children: [
              Text(
                'Именные деньги - это замечательный способ для привлечения денежной энергии. При указании Ваших данных (ФИО)  идет автоматический расчет ваших индивидуальных числовых комбинаций. Далее, имея эти числа, вам предлагается использовать их в повседневной жизни.',
                style: GoogleFonts.montserrat(
                  fontSize: 11.sp,
                  color: Color.fromARGB(255, 73, 80, 87),
  ...
  @override
  String getName() {
    return Routes.custom_money_screen;
  }
}
