...
class MoneyNumberResult extends StatelessWidget implements Navigatable {
  @override
          ...
          children: [
            Stack(
              children: <Widget>[
                Container(
                  child: Text(
                    '''Пятерка. Этим деньгам нужно сразу находить применение, не дожидаясь «лучших времен». Пустив их в оборот, можно получить хорошую прибыль. Если будут долго лежать без дела – не принесут никакой пользы. Можно смело тратить купюры с цифрой 5. Такие покупки станут успешными, принесут ''',
                    style: GoogleFonts.montserrat(
                      color: Color.fromRGBO(73, 80, 87, 1),
                      fontSize: 11.sp,
  ...
  @override
  String getName() {
    return Routes.money_number_result;
  }
}
