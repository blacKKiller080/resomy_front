...
class FamilyNumberScreen extends StatelessWidget implements Navigatable {
  @override
  ...
  Widget calculation(BuildContext context) => Container(
        child: Column(
          children: [
            ...
            Text(
              'введите дату рождения вашего супруга',
              textAlign: TextAlign.center,
              style: GoogleFonts.montserrat(
                color: Color.fromRGBO(73, 80, 87, 1),
                fontSize: 10.sp,
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushNamed(context, Routes.family_number_result);
              },
              child: Container(
                width: 39.2.w,
                height: 3.82.h,
                padding: EdgeInsets.only(top: 0.2.h, left: 0.5.w, right: 0.5.w),
        ...
        child: Container(
          child: ListView(
            ...
            children: [
              ...
              Text(
                'Рассчитав сумму личных чисел супругов, вы получите так называемое число семьи и узнаете, гармоничны ли отношения между близкими ',
                style: GoogleFonts.montserrat(
                  fontSize: 10.5.sp,
                  color: Color.fromARGB(255, 73, 80, 87),
  ...
  @override
  String getName() {
    return Routes.family_number_screen;
  }
}
