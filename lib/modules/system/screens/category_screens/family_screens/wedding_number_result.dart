...
class WeddingNumberResult extends StatelessWidget implements Navigatable {
  @override
          ...
          children: [
            Stack(
              children: <Widget>[
                Container(
                  child: Text(
                    '''Число Свадьбы 5 делает семейную жизнь увлекательной и разнообразной. Однако часто супруги предпочитают получать новые впечатления поодиночке, то есть каждый живет в своей собственной «вселенной». Впрочем, те, кто изначально «смотрел в одном направлении», не подпадают под негативное влияние Пятерки. Они вместе познают окружающий мир, путешествуют или занимаются совместным бизнесом. ''',
                    style: GoogleFonts.montserrat(
                      color: Color.fromRGBO(73, 80, 87, 1),
                      fontSize: 11.sp,
  ...
  @override
  String getName() {
    return Routes.wedding_number_result;
  }
}
