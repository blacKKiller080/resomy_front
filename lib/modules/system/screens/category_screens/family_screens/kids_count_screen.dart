...
class KidsCountScreen extends StatelessWidget implements Navigatable {
  @override
  ...
  Widget calculation(BuildContext context) => Container(
        child: Column(
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushNamed(context, Routes.kids_count_result);
              },
              child: Container(
                width: 39.2.w,
                height: 5.55.h,
  ...
  Widget imageContainer() => Positioned(
        ...
        child: Container(
          child: Image.asset(
            'assets/images/jpg/kids_count_screen.jpg',
            width: 81.6.w,
            height: 17.85.h,
          ),
          width: 89.06.w,
  ...
  Widget information() => Positioned(
        ...
        child: Container(
          child: ListView(
            ...
            children: [
              Text(
                'Хотите знать, сколько детей подарит вам судьба? Тогда данный нумерологический расчет как раз для вас. При помощи вашей даты рождения и количества ваших братьев и сестер нумерология поможет рассчитать возможное количество малышей, предназначенных вам свыше.',
                style: GoogleFonts.montserrat(
                  fontSize: 11.sp,
                  color: Color.fromARGB(255, 73, 80, 87),
  ...
  @override
  String getName() {
    return Routes.kids_count_screen;
  }
}
