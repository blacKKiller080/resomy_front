...
class BioritmScreen extends StatelessWidget implements Navigatable {
  @override
  ...
  Widget calculation(BuildContext context) => Container(
        child: Column(
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushNamed(context, Routes.bioritm_result);
              },
              child: Container(
                width: 39.2.w,
                height: 3.82.h,
  ...
  Widget information() => Positioned(
        ...
        child: Container(
          child: ListView(
            ...
            children: [
              Text(
                'Какимы бывают биологические ритмы?',
                textAlign: TextAlign.center,
                style: GoogleFonts.montserrat(
                  fontSize: 12.sp,
                  color: Color.fromARGB(255, 73, 80, 87),
              ...
              Text(
                '''Человек со дня рождения находится в трех биологических ритмах:
