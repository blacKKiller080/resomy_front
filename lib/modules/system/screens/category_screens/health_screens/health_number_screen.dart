...
class HealthNumberScreen extends StatelessWidget implements Navigatable {
  @override
  ...
  Widget calculation(BuildContext context) => Container(
        child: Column(
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushNamed(context, Routes.health_number_result);
              },
              child: Container(
                width: 39.2.w,
                height: 5.55.h,
  ...
  Widget imageContainer() => Positioned(
        ...
        child: Container(
          child: Image.asset(
            'assets/images/jpg/health_number_screen.jpg',
          ),
          width: 89.06.w,
          height: 28.94.h,
          decoration: BoxDecoration(
  ...
  Widget information() => Positioned(
        ...
        child: Container(
          child: ListView(
            ...
            children: [
              Text(
                'При расчете должна выйти одна цифра, она определит ваше состояние здоровья.',
                style: GoogleFonts.montserrat(
                  fontSize: 11.5.sp,
                  color: Color.fromARGB(255, 73, 80, 87),
          ...
          padding:
              EdgeInsets.only(left: 5.w, top: 1.5.h, right: 5.w, bottom: 1.5.h),
          width: 89.06.w,
          height: 9.h,
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(15),
  ...
  @override
  String getName() {
    return Routes.health_number_screen;
  }
}
