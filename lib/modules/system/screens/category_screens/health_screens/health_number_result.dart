...
class HealthNumberResult extends StatelessWidget implements Navigatable {
  @override
          ...
          children: [
            Stack(
              children: <Widget>[
                Container(
                  child: Text(
                    '''Для пятерки характерны  головные боли, нарушения сна,  проблемы с  нервной системой. Необходимо больше отдыхать, полноценно высыпаться, желательно не менее 8 часов, больше проводить времени на свежем воздухе, укреплять свой организм особенно осенью и весной. Овсяная каша, петрушка, рис, картофель. Из трав отлично подойдет валериана. ''',
                    style: GoogleFonts.montserrat(
                      color: Color.fromRGBO(73, 80, 87, 1),
                      fontSize: 11.sp,
  ...
  @override
  String getName() {
    return Routes.health_number_result;
  }
}
