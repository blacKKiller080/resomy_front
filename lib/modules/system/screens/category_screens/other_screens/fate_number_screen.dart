...
class FateNumberScreen extends StatelessWidget implements Navigatable {
  @override
  ...
  Widget calculation(BuildContext context) => Container(
        child: Column(
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushNamed(context, Routes.fate_number_result);
              },
              child: Container(
                width: 39.2.w,
                height: 5.55.h,
  ...
  Widget imageContainer() => Positioned(
        ...
        child: Container(
          child: Image.asset(
            'assets/images/jpg/fate_number_screen.jpg',
          ),
          width: 89.06.w,
          height: 22.66.h,
          decoration: BoxDecoration(
        ...
        child: Container(
          child: ListView(
            ...
            children: [
              ...
              Text(
                'Зная свое Число Судьбы, ты сможешь избежать многих ошибок и полностью реализовать свои таланты и способности. Именно этим числом определяется место место в мире и общие очертания жизненного пути – который, конечно, ты сможешь скорректировать и изменить, если сочтешь нужным.',
                style: GoogleFonts.montserrat(
                  fontSize: 11.sp,
                  color: Color.fromARGB(255, 73, 80, 87),
  ...
  @override
  String getName() {
    return Routes.fate_number_screen;
  }
}
