...
class TraitsResult extends StatelessWidget implements Navigatable {
  @override
            ...
            children: [
              Column(
                children: [
                  ...
                  Image.asset(
                    'assets/images/jpg/traits_result.jpg',
                    // width: 13.3.w,
                    // height: 6.15.h,
                  ),
                  Text(
                    '''Единица – число лидеров! Оно принадлежит властным и могущественным людям, которые не боятся трудностей и в любых ситуациях проявляют стойкость. Только уж очень упрямы и считают, что во всем правы.''',
                    style: GoogleFonts.montserrat(
