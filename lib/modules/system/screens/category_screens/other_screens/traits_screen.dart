...
class TraitsScreen extends StatelessWidget implements Navigatable {
  @override
  ...
  Widget calculation(BuildContext context) => Container(
        child: Column(
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushNamed(context, Routes.traits_result);
              },
              child: Container(
                width: 39.2.w,
                height: 5.55.h,
...
''',
              ...
              Text(
                '''Каждый человек — это личность с индивидуальным характером, талантами и собственным видением происходящего. Но порой мы сами не учитываем особенности нашего характера и живем «по шаблону». Почему так происходит? Просто мы не знаем, как выявить собственные индивидуальные особенности! Для понимания себя необходимо немного желания и усилий. А нумерология поможет нам разобраться в собственном характере!''',
                style: GoogleFonts.montserrat(
                  fontSize: 11.sp,
                  color: Color.fromARGB(255, 73, 80, 87),
