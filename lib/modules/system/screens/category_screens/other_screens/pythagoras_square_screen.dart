...
class PythagorasSquareScreen extends StatelessWidget implements Navigatable {
  @override
  ...
  Widget calculation(BuildContext context) => Container(
        child: Column(
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushNamed(context, Routes.pythagoras_square_result);
              },
              child: Container(
                width: 39.2.w,
                height: 5.55.h,
        ...
        child: Container(
          child: ListView(
            ...
            children: [
              ...
              Text(
                '''Квадрат Пифагора еще называют Картой судьбы или Психоматрицей. Это уникальный метод, который использовался еще египетскими жрецами. Пифагор доработал метод, такчто теперь по дате рождения вы можете узнать все о человека. Квадрат Пифагора - это очень мощный аналитический инструмент. Он позволяет выявить основные особенности личности обусловленные датой рождения. Все, что Вы узнаете в описании чисел психоматрицы - это Ваши изначальные данные, возможности и способности, данные Вам при рождении. Что же касается того, как они повлияют на Вашу жизнь, зависит только от Вас. В Ваших силах использовать все свои положительные задатки по максимуму, или же Вы можете их просто игнорировать.''',
                style: GoogleFonts.montserrat(
                  fontSize: 10.5.sp,
                  color: Color.fromARGB(255, 73, 80, 87),
  ...
  @override
  String getName() {
    return Routes.pythagoras_square_screen;
  }
}
