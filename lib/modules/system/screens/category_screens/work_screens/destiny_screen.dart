...
class DestinyScreen extends StatelessWidget implements Navigatable {
  @override
  ...
  Widget calculation(BuildContext context) => Container(
        child: Column(
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushNamed(context, Routes.destiny_result);
              },
              child: Container(
                width: 39.2.w,
                height: 5.55.h,
  ...
  Widget imageContainer() => Positioned(
        ...
        child: Container(
          child: Image.asset(
            'assets/images/jpg/destiny_screen.jpg',
          ),
          width: 89.06.w,
          height: 22.66.h,
          decoration: BoxDecoration(
