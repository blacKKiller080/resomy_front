...
class ProfessionChoiceResult extends StatelessWidget implements Navigatable {
  @override
  ...
  Widget imageContainer() => Container(
        child: Image.asset(
          'assets/images/jpg/profession_choice_result.jpg',
        ),
        width: 88.93.w,
        height: 24.13.h,
        decoration: BoxDecoration(
  ...
  Widget information() => Container(
        child: ListView(
          ...
          children: [
            Text(
              '''Вам необходим простор для самовыражения и общения с людьми. Это коммерческое искусство, модельный бизнес, торговля, ресторанный бизнес. Актер, музыкант, дизайнер, гид, парикмахер, работник гостиницы или ресторана.''',
              style: GoogleFonts.montserrat(
                fontSize: 11.sp,
  ...
  @override
  String getName() {
    return Routes.profession_choice_result;
  }
}
