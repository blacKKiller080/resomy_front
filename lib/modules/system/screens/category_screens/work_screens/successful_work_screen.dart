...
class SuccessfulWorkScreen extends StatelessWidget implements Navigatable {
  @override
  ...
  Widget calculation(BuildContext context) => Container(
        child: Column(
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushNamed(context, Routes.successful_work_result);
              },
              child: Container(
                width: 39.2.w,
                height: 5.55.h,
  ...
  Widget imageContainer() => Positioned(
        ...
        child: Container(
          child: Image.asset(
            'assets/images/jpg/successful_work_screen.jpg',
          ),
          height: 22.66.h,
          width: 89.06.w,
          decoration: BoxDecoration(
  ...
  Widget information() => Positioned(
        ...
        child: Container(
          child: ListView(
            ...
            children: [
              Text(
                'Счастливчиков не так уж и мало. Они никогда не останутся на мели, им всегда подфартит, они достигнут больших результатов за более короткий отрезок времени. И при этом приложат меньше сил и усилий. Ну, а если вы – не денежный счастливчик, все равно средства можно заработать, главное – направить усилия в нужное русло.',
                style: GoogleFonts.montserrat(
                  fontSize: 11.sp,
                  color: Color.fromARGB(255, 73, 80, 87),
  ...
  @override
  String getName() {
    return Routes.successful_work_screen;
  }
}
